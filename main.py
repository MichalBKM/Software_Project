...
def kmeans_pp(k, iter, eps, file_name_1, file_name_2):
    ...
    #print("datapoints:\n",datapoints)
    n = len(datapoints)
    centroids = np.array([datapoints[random.randint(0,n-1)]]) #choose one center uniformly at random among the datapoints
    ...
    while len(centroids)!=k:
        ...
        #print("prob:\n",prob)
        chosen_cent = random.choices(datapoints,weights=prob,k=1)[0]
